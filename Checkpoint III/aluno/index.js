...
let aluno1 = new aluno.ConstruirAluno('Charles Xavier',4,[10,6,8],this.calcularMedia,this.faltas)
let aluno2 = new aluno.ConstruirAluno('Lazaro Dias', 3,[9,10,8], this.calcularMedia,this.faltas)
let aluno3 = new aluno.ConstruirAluno('Lampião', 2,[7,3,4], this.calcularMedia,this.faltas)
let aluno4 = new aluno.ConstruirAluno('Maria Bonita', 1,[5,6,8], this.calcularMedia,this.faltas)
